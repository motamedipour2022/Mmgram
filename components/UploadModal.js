...
export default function UploadModal() {
  ...
  return (
    <div>
        ...
        {open && (
            <Modal
            className="max-w-lg w-[90%] p-6 absolute top-56 left-[50%] translate-x-[-50%] bg-white border-2 border-gray-500 rounded-md shadow-md"
              isOpen={open}
            ...
            >
              <div className="flex flex-col justify-center items-center h-[80%]">
                ...
                <input type="text" maxLength="150" placeholder="Please enter your caption..." className="m-4 border-none text-center w-full focus:ring-0 " ref={captionRef} />
